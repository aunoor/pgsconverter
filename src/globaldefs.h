...
enum CFG_USER_SAFETY_INFO
{
   ...
   CFG_USER_SAFETY_INFO_TYPE_DEDICATED_LANE_CAM=12,//камера, контролирующая полосу для маршрутного транспорта
   CFG_USER_SAFETY_INFO_TYPE_PASSWAY=13 //пешеходный переход
};
